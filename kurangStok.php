...
<div class="row">
  <div class="box">
    ...
    <div class="col-lg-7 col-md-7 col-sm-7"> 
      ...
      <form method="post" action="kurangStokBuku.php">
        ...
        <div class="form-horizontal">
          ...
          <div class="form-group">
            <label for="stok" class="control-label col-sm-2">Stok Keluar</label><div class="col-sm-4"><input type="text" id="stok" placeholder="Stok Keluar" class="form-control" name="stok">
            </div>
